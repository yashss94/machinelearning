...
def EM(tau1, tau2, mew1, mew2, S1, S2, X):
    ...
    return tau1, tau2, mew1, mew2, S1, S2
...
tau1, tau2, mew1, mew2, S1, S2 = EM(tau1, tau2, mew1, mew2, S1, S2, X)

print("Converged values of Tau, Theta and S for (a) part using given initializations:")
print("Tau1",tau1)
print("Tau2",tau2)
...
print("Converged values of Tau, Theta and S for (b) part using random initializations:")
print("Tau1",tau1)
print("Tau2",tau2)
print("Mew1",np.atleast_2d(mew1).T)
print("Mew2",np.atleast_2d(mew2).T)
